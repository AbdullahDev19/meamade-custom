...
const plugins = [
  // ...,
  {
    ...
    options: {
      ...
      admin_orders_url: `http://localhost:7001/a/order`,
    },
  },
]
```
...
- The `admin_orders_url` is the prefix of the URL of the order detail pages on your admin panel. If you’re using Medusa’s Admin locally, it should be `http://localhost:7001/a/order`. This will result in a URL like `http://localhost:7001/a/order/order_01FYP7DM7PS43H9VQ1PK59ZR5G`.
